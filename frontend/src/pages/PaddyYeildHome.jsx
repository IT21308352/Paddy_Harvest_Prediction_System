  ...
  const cultivationDetails = [
    {
      ...
      image:
        "https://kisanvedika.bighaat.com/wp-content/uploads/2022/12/prahlad-inala-BJlJG23ciXI-unsplash.jpg",
      ...
      >
        ...
        <div className="relative mx-auto px-4 sm:px-6 lg:py-16 flex flex-col h-full">
          ...
          >
            ...
            <p className="text-xl w-4/5 mx-auto text-gray-100/90 leading-relaxed py-5">
            ...
            <motion.button
              ...
              className="bg-darkgreen hover:bg-darkyellow text-white capitalize py-4 px-8 my-5 rounded-xl text-lg font-bold shadow-lg transition-all duration-300 "
            >
