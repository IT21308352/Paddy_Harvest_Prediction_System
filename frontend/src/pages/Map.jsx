...
const Map = () => {
  ...
  return (
    <div className="bg-green-100">
      <div className="flex">
        <div
          className="relative w-2/5 items-center overflow-hidden"
          style={{
            height: "80vh",
        ...
        >
          ...
          {hoveredDistrict && (
            <div className="absolute w-96 left-10 top-10 p-2 bg-gray-800/40 text-white border border-gray-300 rounded shadow-lg">
              {hoverText}
            </div>
          )}
        </div>
        <div className="container w-3/5 bg-gray-200 p-10">
